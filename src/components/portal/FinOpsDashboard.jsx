...
const FinOpsDashboard = () => {
    ...
    return (
        <div className="w-full bg-slate-50 dark:bg-slate-900/50 p-6 rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm">
            ...
            <div className="flex flex-col md:flex-row justify-between items-start md:items-center mb-8 gap-4">
                <div>
                    ...
                    <p className="text-slate-500 dark:text-slate-400">
                        Real-time cost visibility and optimization insights.
                    </p>
                </div>
            ...
            <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-4 mb-8">
                <Card className="bg-white dark:bg-slate-800 border-l-4 border-l-brand-blue shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-slate-500">Current Month Spend</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-slate-900 dark:text-white">$42,350</div>
                        <div className="text-sm text-slate-500 mt-1 flex items-center gap-1">
                            <span className="text-red-500 font-medium">+5%</span> vs last month
                        </div>
                        <Progress value={78} className="h-1.5 mt-3 bg-slate-100 dark:bg-slate-700" indicatorClassName="bg-brand-blue" />
                        <div className="text-xs text-slate-400 mt-1 text-right">78% of Budget</div>
                    </CardContent>
                </Card>

                <Card className="bg-white dark:bg-slate-800 border-l-4 border-l-amber-500 shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-slate-500">Forecasted EOM</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-slate-900 dark:text-white">$54,100</div>
                        <div className="text-sm text-slate-500 mt-1 flex items-center gap-1">
                ...
                <Card className="bg-white dark:bg-slate-800 border-l-4 border-l-green-500 shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-slate-500">Savings Realized</CardTitle>
                    </CardHeader>
                    <CardContent>
                ...
                <Card className="bg-white dark:bg-slate-800 border-l-4 border-l-purple-500 shadow-sm">
                    <CardHeader className="pb-2">
                        <CardTitle className="text-sm font-medium text-slate-500">Governance Score</CardTitle>
                    </CardHeader>
                    <CardContent>
                        <div className="text-3xl font-bold text-slate-900 dark:text-white">92/100</div>
                        <div className="text-sm text-slate-500 mt-1">Policy Compliance</div>
            ...
            <Tabs defaultValue="overview" className="space-y-6">
                ...
                <TabsContent value="overview" className="space-y-6 animate-in fade-in slide-in-from-bottom-2 duration-300">
                    <div className="grid grid-cols-1 lg:grid-cols-3 gap-6">
                        {/* Cost Trend Chart */}
                        <Card className="lg:col-span-2 bg-white dark:bg-slate-800 shadow-sm">
                            <CardHeader>
                                    ...
                                    <tbody className="divide-y divide-slate-100 dark:divide-slate-800">
                                        {topDrivers.map((driver, idx) => (
                                            <tr key={idx} className="hover:bg-slate-50 dark:hover:bg-slate-800/50 transition-colors">
                                                <td className="px-4 py-3 font-medium text-slate-900 dark:text-white">{driver.resource}</td>
                                                <td className="px-4 py-3 text-slate-500">{driver.type}</td>
                                                <td className="px-4 py-3 font-mono text-slate-700 dark:text-slate-300">${driver.cost}</td>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                        <Card className="bg-white dark:bg-slate-800 shadow-sm border-l-4 border-l-green-500">
                            <CardHeader>
                                ...
                                <CardDescription>Potential Monthly Savings: <span className="text-slate-900 dark:text-white font-bold">$15,900</span></CardDescription>
                            </CardHeader>
                ...
                <TabsContent value="drilldown" className="space-y-6 animate-in fade-in slide-in-from-right-2 duration-300">
                    <Card className="bg-slate-100 dark:bg-slate-800 border-dashed border-2 border-slate-300 dark:border-slate-700 min-h-[300px] flex items-center justify-center">
                        <div className="text-center">
                            <Filter className="w-12 h-12 text-slate-400 mx-auto mb-4" />
                            <h3 className="text-lg font-medium text-slate-600 dark:text-slate-300">Detailed Transaction Logs</h3>
