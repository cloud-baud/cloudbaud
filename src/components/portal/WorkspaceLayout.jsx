...
const businessApps = [
    ...
    { icon: LifeBuoy, label: 'Customer Support', href: '/portal/support' },
    { icon: Users, label: 'CRM', href: '/portal/crm' },
    { icon: TrendingUp, label: 'Sales', href: '/portal/sales' },
];
    ...
    return (
        <div className="flex flex-col h-screen bg-background font-sans text-foreground overflow-hidden">
            ...
            <div className="flex-1 flex overflow-hidden bg-[#f3f4f6] dark:bg-black/20">
                ...
                <aside
                    className={cn(
                        "flex-shrink-0 flex flex-col pt-6 pb-4 pl-4 lg:pl-6 bg-transparent h-full transition-all duration-300 ease-in-out overflow-y-auto custom-scrollbar",
                        isSidebarCollapsed ? "w-[88px]" : "w-[280px]"
                    )}
                >
                    {/* Card 1: Navigation & Actions */}
                    <div className="bg-white dark:bg-[#1a1a1a] rounded-xl border border-slate-200 dark:border-slate-800 shadow-sm overflow-hidden mb-4 mr-2 flex flex-col shrink-0">
                        ...
                        <div className="px-2 pb-4 pt-2 space-y-6">
                            <Section title="Overview" collapsed={isSidebarCollapsed}>
                                <SidebarLink icon={FileText} label="My Feed" href="/portal" active collapsed={isSidebarCollapsed} />
                                <SidebarLink icon={Users} label="My Network" href="/portal/network" collapsed={isSidebarCollapsed} />
                            </Section>

                            <Section title="Business Areas" collapsed={isSidebarCollapsed}>
...
const SidebarLink = ({ icon: Icon, label, href, active, collapsed, children }) => {
