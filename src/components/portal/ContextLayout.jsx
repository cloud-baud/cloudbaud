...
const SUB_NAVS = {
    'finance': [
        ...
        { label: 'Accounting', href: '/portal/finance-board/accounting', icon: PieChart },
        { label: 'Investments', href: '/portal/finance-board/investments', icon: TrendingUp },
    ],
...
const ContextLink = ({ href, label, icon: Icon, children }) => {
    ...
    // For Taxes: href=/portal/finance-board. location=/portal/finance-board?year=2024. Match.
...
const ContextLayout = () => {
    ...
    if (location.pathname.includes('/portal/finance-board')) {
