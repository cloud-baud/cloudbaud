            ...
            <section className="py-12 px-4 sm:px-6 lg:px-8 bg-white dark:bg-background overflow-hidden relative">
                <div className="max-w-7xl mx-auto">
                    <div className="grid grid-cols-1 lg:grid-cols-2 gap-16 items-center">
                        <div>
                            <div className="inline-block px-4 py-1.5 rounded-full bg-blue-100 dark:bg-brand-blue/20 text-blue-700 dark:text-brand-blue font-semibold text-sm mb-6">
                        ...
                        <div className="relative">
                            <div className="absolute inset-0 bg-gradient-to-tr from-blue-100 to-purple-100 dark:from-brand-blue/10 dark:to-purple-900/20 rounded-3xl transform rotate-3 scale-105 opacity-60"></div>
                ...
                <section className="py-16 px-4 sm:px-6 lg:px-8 bg-slate-50 dark:bg-slate-900/30">
                    <div className="max-w-7xl mx-auto">
                        <div className="text-center max-w-3xl mx-auto mb-16">
                            <h2 className="text-3xl font-bold text-slate-900 dark:text-white mb-4">Why we use {technology.text}</h2>
