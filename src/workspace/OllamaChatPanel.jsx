...
import { createContact } from '@/workspace/crm/contactsService';
...
const OllamaChatPanel = ({ isOpen = true, onClose, onToggleCollapse,variant = 'embedded', trigger, contextData, onProcessComplete, onStatusChange }) => {
            ...
            {(variant === 'overlay' || variant === 'docked') && (
                <div className="flex items-center justify-between p-4 border-b border-border bg-muted/30">
                    ...
                    <Button 
                        variant="ghost" 
                        size="icon" 
                        onClick={variant === 'docked' ? (onToggleCollapse|| onClose) : onClose} 
